...
from .views import CourseCRUDView, CreateCourseView, AddStaffToCourse, ClearCourseStaff, RemoveStaffFromCourse, CourseDetailsGetBySlug, ModuleCreateAndListView, ModuleCRUDView, TopicCreateAndListView, TopicCRUDView, VideoCreateAndListView,VideoCRUDView, DocumentCRUDView, DocumentCreateAndListView
...
urlpatterns = [
    ...
    path("<slug:slug>/", CourseDetailsGetBySlug.as_view(), name="add-staff-to-course"),
